...
const GenderSelection = ({ selectedGender, onChange }: GenderSelectionProps) => {
  return (
    <div className="flex flex-col items-start gap-4 overflow-hidden rounded-md p-6 shadow-sm shadow-[#00000050] bg-dark-purple border border-primary-purple/30">
      <span className="text-center font-mono text-base font-black uppercase text-primary-purple">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative flex h-[50px] w-[50px] items-center justify-center">
          <input
            ...
            onChange={() => onChange('prefer-not-to-say')}
            className="peer z-10 h-full w-full cursor-pointer opacity-0"
          />
