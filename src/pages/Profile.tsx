    ...
    <div className="container mx-auto py-10 px-4">
      <div className="flex flex-col md:flex-row gap-8">
        <div className="w-full md:w-1/3">
          {/* Profile Card */}
          <div className="group before:hover:scale-95 before:hover:h-72 before:hover:h-44 before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-[''] before:w-80 before:h-24 before:rounded-t-2xl before:bg-gradient-to-bl from-primary-purple via-secondary-purple to-tertiary-purple before:absolute before:top-0 w-80 h-72 relative bg-dark-purple flex flex-col items-center justify-center gap-2 text-center rounded-2xl overflow-hidden">
            <div className="w-28 h-28 bg-primary-purple mt-8 rounded-full border-4 border-dark-purple z-10 group-hover:scale-150 group-hover:-translate-x-24 group-hover:-translate-y-20 transition-all duration-500">
            ...
            <Button className="bg-primary-purple px-4 py-1 text-white rounded-md z-10 hover:scale-125 transition-all duration-500 hover:bg-secondary-purple">
              Follow
            </Button>
          </div>
          ...
          {!showSocialLinks ? (
            ...
            <Card className="mt-4 p-4 flex items-center justify-center gap-4 bg-dark-purple border-primary-purple/30">
          ...
          <Tabs defaultValue="courses">
            ...
            <TabsContent value="skills">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <Card className="p-4 bg-dark-purple border-primary-purple/30">
